...
public:
	...
	ecs::entity_t CreateImageEntity(ecs::EntityManager* _entityManager, std::string _idImage, AreaType _typeRect,
	...
	ecs::entity_t CreateInteractableEntity(ecs::EntityManager* _entityManager, std::string _idImage, AreaType _typeRect,
	Vector2D _pos, Vector2D _dir, int _width, int _height, int _rot,
	...
	ecs::entity_t CreateInteractableEntityScroll(ecs::EntityManager* _entityManager, std::string _idImage, AreaType _typeRect,
	Vector2D _pos, Vector2D _dir, int _width, int _height, int _rot,

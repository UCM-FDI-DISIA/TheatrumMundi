...
#pragma endregion
		...
		shovel = entityFactory->CreateInteractableEntity(entityManager, "Pala", EntityFactory::RECTAREA, Vector2D(800, 300), Vector2D(0, 0), 300, 300, 90, areaLayerManager, EntityFactory::NODRAG, ecs::grp::DEFAULT);
